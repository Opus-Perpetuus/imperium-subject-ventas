        ...
        props: {
          ...
          form: {
            fields: [
              ...
              { name: "monto_umbral", component: "input-money", label: "monto umbral" },
              ...
              { name: "precio_unitario", component: "input-money", label: "precio unitario" },
              ...
              { name: "pedido_total", component: "input-money", label: "pedido total" },
