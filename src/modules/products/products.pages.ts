        ...
        props: {
          ...
          form: {
            fields: [
              ...
              { name: "unidad", component: "input-datalist", label: "unidad", optionsSource: "api://m/subject-almacen/unit-of-measure?as=options&limite=1000" },
              ...
              { name: "costoCompraPromedio", component: "input-money", label: "costoCompraPromedio" },
              { name: "ultimoCostoCompra", component: "input-money", label: "ultimoCostoCompra" },
              { name: "fechaUltimaCompra", component: "input-date", label: "fechaUltimaCompra" },
              { name: "stockMinimo", component: "input-number", label: "stockMinimo" },
              { name: "stockMaximo", component: "input-number", label: "stockMaximo" },
              ...
              { name: "ubicacion_preferida", component: "input-datalist", label: "ubicacion preferida", optionsSource: "api://m/subject-almacen/inventory-internal-location?as=options&limite=1000" },
