...
export const sku_pages: KirletPageDecl[] = [
  {
    id: "ventas.sku",
    path: "sku",
      ...
      build_feature_shell_page({
        ...
        props: {
          ...
          data: {
            list: `${API}/sku`,
            record: `${API}/sku/:id`,
            create: { method: "POST", action: `${API}/sku` },
            update: { method: "PATCH", action: `${API}/sku/:id` },
            delete: { method: "DELETE", action: `${API}/sku/:id` },
          },
          table: {
            columns: [
              ...
              { key: "existencia", label: "existencia", sortable: true, priority: 3 },
            ],
            fillHeight: true,
            serverQuery: true,
          },
